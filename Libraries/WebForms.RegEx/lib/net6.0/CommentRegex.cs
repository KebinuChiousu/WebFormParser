...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.CommentRegex" /> class.</summary>
    public CommentRegex()
    {
      this.pattern = "\\G<%--(([^-]*)-)*?-%>";
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.CommentRegex" /> class with the specified time-out value.</summary>
