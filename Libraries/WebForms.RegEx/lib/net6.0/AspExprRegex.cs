...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.AspExprRegex" /> class.</summary>
    public AspExprRegex()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.AspExprRegex" /> class with a specified time-out value.</summary>
