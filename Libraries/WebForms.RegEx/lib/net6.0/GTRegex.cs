...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.GTRegex" /> class.</summary>
    public GTRegex()
    {
      this.pattern = "[^%]>";
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.GTRegex" /> class with a specified time-out value.</summary>
