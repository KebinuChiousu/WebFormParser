...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.TagRegex" /> class.</summary>
    public TagRegex()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.TagRegex" /> class with a specified time-out value.</summary>
