...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.AspCodeRegex" /> class.</summary>
    public AspCodeRegex()
    {
      this.pattern = "\\G<%(?!@)(?<code>.*?)%>";
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.AspCodeRegex" /> class with a specified time-out value.</summary>
