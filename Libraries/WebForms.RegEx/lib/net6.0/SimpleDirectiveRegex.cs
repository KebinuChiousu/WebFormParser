...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.SimpleDirectiveRegex" /> class.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.SimpleDirectiveRegex" /> class with a specified time-out value.</summary>
