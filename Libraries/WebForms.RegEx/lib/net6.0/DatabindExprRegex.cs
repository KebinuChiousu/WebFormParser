...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.DatabindExprRegex" /> class.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.DatabindExprRegex" /> class with a specified time-out value.</summary>
