...
namespace WebForms.RegEx.Runner
{
    internal class TagRegexRunner1 : RegexRunner
    {
            ...
            if (num1 == this.runtextstart)
            {
                ...
                if (num1 < runtextend && runtext[num1++] == '<')
                {
                    ...
                    if (1 <= runtextend - num1)
                    {
                        ++num1;
                        int num6 = 1;
                        while (CharInClass(runtext[num1 - num6--], "\0\u0004\n./:;\0\u0002\u0004\u0005\u0003\u0001\u0006\t\u0013\0"))
                        {
                            if (num6 <= 0)
                            {
                                CheckTimeout();
        ...
        label_13:
            ...
            if (1 <= runtextend - num1)
            {
                ++num1;
                int num16 = 1;
                while (CharInClass(runtext[num1 - num16--], "\0\0\u0001d"))
                {
                    if (num16 <= 0)
                    {
                        CheckTimeout();
                        ...
                        while (--num18 > 0)
                        {
                            if (!CharInClass(runtext[num1++], "\0\0\u0001d"))
                            {
                                --num1;
                                break;
                            }
            ...
            runtrack[--num5] = 1;
            CheckTimeout();
            if (num1 < runtextend && CharInClass(runtext[num1++], "\0\0\n\0\u0002\u0004\u0005\u0003\u0001\u0006\t\u0013\0"))
            {
                CheckTimeout();
                int num21;
        ...
        label_132:
            ...
            while (true)
            {
                ...
                do
                {
                    do
                    {
                        ...
                        label_149:
                            ...
                            int index27 = num127;
                            num1 = index27 + 1;
                            if (CharInClass(str2[index27], "\0\u0001\0\0"))
                            {
                                if (num128 > 0)
                                {
                                    int num129;
                ...
                while (!CharInClass(str1[index11], "\0\0\u0001d"));
                goto label_172;
            label_175:
                CheckTimeout();
                runstack[--num4] = runtrack[num5++];
        ...
        label_102:
            ...
            while (--num186 > 0)
            {
                if (!CharInClass(runtext[num1++], "\u0001\b\u0001\"#'(/0=?d"))
                {
                    --num1;
                    break;
                }
        ...
        protected override void InitTrackCount() => runtrackcount = 53;
    }
}
