...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.DirectiveRegex" /> class.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.DirectiveRegex" /> class with a specified time-out value.</summary>
