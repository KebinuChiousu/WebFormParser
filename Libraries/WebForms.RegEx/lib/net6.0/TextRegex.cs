...
namespace WebForms.RegEx
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.TextRegex" /> class.</summary>
    public TextRegex()
    {
      this.pattern = "\\G[^<]+";
    ...
    /// <summary>Initializes a new instance of the <see cref="T:WebForms.RegEx.TextRegex" /> class with a specified time-out value.</summary>
